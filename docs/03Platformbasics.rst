...
602, 603, 604, 802,803 are names **CANIAS ERP** versions and all are designed to run on a major TROIA Platform version. (602 works on 3.08.xx xxxxxx, 603 works on 5.01.xx xxxxxx, 604 works on 5.02.xx xxxxxx, 802 works on 8.02.xx xxxxxx, 803 works on 8.03.xx xxxxxx). In other words; 602, 603, 604, 802, 803 are not valid version names for TROIA Platform.
