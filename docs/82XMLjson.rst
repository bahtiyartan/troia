...
::
	...
	MAP RELATION Order TO Customer LINK CustomerId
					WITH CustomerId GENERATE NO IN SALESMAP;
...
::
	...
	MAP RELATION Orders TO Customer LINK CustomerId 
						WITH CustomerId GENERATE YES IN SALESMAP;
	...
	MAP RELATION Order TO Orders LINK CustomerFK 
						WITH CustomerFK GENERATE YES IN SALESMAP;
...
.. code-block:: xml
	...
	<string xmlns="http://tempuri.org/">
	  <Orders>
		<Order id="66D0C273AF3D8754C3B01B6B471B75E0">
		  <Order_org>23666D10FC6D4F66A474EDF205DA4EEE</Order_org>
		  <Orderline id="4F2A2F5565D24234937B89A2A96D0473">
			<OrderLine_org>23666D10FC6D4F66A474EDF205DA4EEE</OrderLine_org>
		  </Orderline>
		  <Orderline id="16F171CD699E4BB09F90E25EBC3BD087">
			<OrderLine_org>23666D10FC6D4F66A474EDF205DA4EEE</OrderLine_org>
		  </Orderline>
		</Order>
	  </Orders>
...
::
	...
	MAP RELATION Orderline TO Order LINK orderid WITH orderid GENERATE YES IN SALESMAP;
