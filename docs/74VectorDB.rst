...
::
	...
	IF SYS_STATUS == 0 THEN
		VECTORDBACTION ADDEMBEDDINGS CONNECTIONNAME VECTORCONNAME COLLECTIONNAME 'testcollection' CHUNKSTABLE CHUNKSTABLE;
...
::
	...
	IF SYS_STATUS == 0 THEN
		VECTORDBACTION SEARCH 
			CONNECTIONNAME VECTORCONNAME COLLECTIONNAME 'testcollection' 
			EMBEDDINGS SEARCHEMBEDDINGS 
			LIMIT 4 THRESHOLD 0.95 
			INTO RESULTS;
