...
::
	...
	MAKEENDPOINTCONNECTION CONNAME ENDPOINTID MYENDPOINTID;
...
::
	...
	IF SYS_STATUS == 0 THEN
		VECTORDBACTION CONNECTIONNAME CONNAME METHOD 'COLLECTIONEXISTS' COLLECTIONNAME MYCOLLECTIONNAME;
...
::
	...
	VECTORDBACTION CONNECTIONNAME CONNAME METHOD 'DELETECOLLECTION' COLLECTIONNAME MYCOLLECTIONNAME;
...
::
	...
	IF SYS_STATUS == 0 THEN
		VECTORDBACTION CONNECTIONNAME CONNAME METHOD 'CREATECOLLECTION' COLLECTIONNAME MYCOLLECTIONNAME COLLECTIONPARAMS MYJSONCOLLECIONPARAMS;
