...
--------------------------
Once you configure Canias Mobile Toolkit access via a mobile device, the system will link your mobile device to your Canias account so it can send you push notifications. You can view the mobile devices linked to your account in **Settings->Mobile Toolkit (Devices)**. From this screen, you can manage or delete devices connected to your account.
