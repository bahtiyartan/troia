...
TROIA Platform, checks **com.sun.management.jmxremote** and **com.sun.management.jmxremote.port** system properties to decide whether jmx is enabled or not. If both these two parameters are provided for the vm, system enables MBeans and its TROIA specific attributes.
