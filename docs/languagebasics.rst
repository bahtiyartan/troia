...
As a fourth generation programming language [https://en.wikipedia.org/wiki/Fourth-generation_programming_language](4GL), TROIA has strong abstraction from all hardware specific details, bytes and bits etc.
